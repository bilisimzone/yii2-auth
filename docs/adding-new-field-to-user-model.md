...
admin panel. Unfortunately at the moment yii2-auth does not support adding new
...
```php
class User extends \coreb2c\auth\models\User
{
...
```php
class RegistrationForm extends \coreb2c\auth\models\RegistrationForm
{
    /**
     * @var string
     */
