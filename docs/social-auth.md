...
yii2-auth provides user registration and login using social sites credentials. It
...
```php
'facebook' => [
    'class'        => 'coreb2c\auth\clients\Facebook',
    'clientId'     => 'APP_ID',
...
```php
'twitter' => [
    'class'          => 'coreb2c\auth\clients\Twitter',
...
- `Authorized redirect URIs` should contain url like `http://localhost/auth/security/auth?authclient=google`

```php
'google' => [
    'class'        => 'coreb2c\auth\clients\Google',
    'clientId'     => 'CLIENT_ID',
...
```php
'github' => [
    'class'        => 'coreb2c\auth\clients\GitHub',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
],
```
...
```php
'vkontakte' => [
    'class'        => 'coreb2c\auth\clients\VKontakte',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET',
]
```
...
- Also you should set the callback url to url like `http://localhost/auth/security/auth?authclient=yandex`.

```php
'yandex' => [
    'class'        => 'coreb2c\auth\clients\Yandex',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
```php
'linkedin' => [
    'class'        => 'coreb2c\auth\clients\LinkedIn',
    'clientId'     => 'CLIENT_ID',
    'clientSecret' => 'CLIENT_SECRET'
],
```
...
yii2-auth also supports all social networks provied by [Yii2-authclient](https://github.com/yiisoft/yii2-authclient) extension.
...
use coreb2c\auth\controllers\SecurityController; 
