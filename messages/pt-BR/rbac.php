...
return [
    ...
    'There is neither role nor permission with name "{0}"' => 'Não existe nem papel nem permissão com o nome "{0}"',
    'Update assignments' => 'Alterações realizadas',
    'Update permission' => 'Alterar permissão',
    'Update role' => 'Alterar papel',
    'Users' => 'Usuários',
    'Select role' => 'Papel',
    'Enter the description' => 'Descrição',
    'Select rule' => 'Regra',
    'Rules' => 'Regras',
    'Class' => 'Classe',
